...
fun DemoRoomResultScreen(
    ...
    DemoRoomResultScreenPreview(navController, harmonyViewModel, fortuneViewModel, resultViewModel, demoViewModel)
}

@Preview
@Composable
fun DemoRoomResultScreenPreview(
