...
import com.fourleafclover.tarot.demo.ui.theme.color.secondaryVariant
...
val demoHarmonyTarotResult = TarotOutputDto(
    tarotId = "1",
    tarotType = 5,
    cards = arrayListOf(1, 2, 3, 4, 5, 6),
    createdAt_ = "2025-12-01T12:38:23.000Z",
    cardResults = arrayListOf(
        CardResultData(
            keywords = arrayListOf("애정", "친밀감", "새로운 분야", "인기"),
            description = "사람들 사이의 정에 무척 민감해지고 사람들과 애정이 깊어지는 때"
